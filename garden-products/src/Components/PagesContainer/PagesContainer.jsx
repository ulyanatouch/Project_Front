...
export { PagesContainer }; // логично что компоненты экспортируются чтобы мы могли их использовать в других частях приложения

// мой компонент PagesContainer отображает контейнер страниц с карточками продаж и предоставляет возможность навигации к отдельным страницам продуктов при клике на карточку
